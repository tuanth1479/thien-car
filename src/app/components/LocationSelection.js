...
// location data
const locations = [
  "Main Street 127, Colombo 05",
  "Woodlend Avenue 45, Kohuwala",
  "Park Road 67, Nugegoda",
];
  ...
  return (
    <Menu as="div" className="w-full h-full flex xl:flex-row">
      <div className="relative flex-1">
        ...
        {/* items */}
        <Menu.Items
          className="drodown-menu shadow-lg absolute -top-56 xl:top-[90px] left-1/2 xl:left-0
        z-10 transform -translate-x-1/2 xl:translate-x-0 text-sm text-center xl:text-left w-full bg-white
        max-x-[332px] py-6 rounded-[10px]"
        >
